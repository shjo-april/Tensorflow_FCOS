...
# 1. dataset
test_data_list = np.load('./dataset/train_detection.npy', allow_pickle = True)[:100]
...
saver.restore(sess, './model/FCOS_{}.ckpt'.format(80000))
...
for data in test_data_list:
    ...
    pred_bboxes, pred_classes = fcos_utils.Decode(total_pred_bboxes[0], total_pred_centers[0], total_pred_classes[0], [w, h], detect_threshold = 0.05)
